...
-- 5. Выберите всех представителей, чьи имена начинаются на латинскую литеру "D" и при этом заканчиваются на латинскую литеру "n". Выборку проведите 2-мя различными способами (2 различных запроса, дающих одинаковый результат).
