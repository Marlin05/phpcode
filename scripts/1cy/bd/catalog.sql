...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 24 2018 г., 05:46
...
(1, 'Автор', 'mail@mail.ru', 'Текст сообщения'),
(2, 'Bvz', '11@2.com', 'fgthuj'),
(3, 'ggg', 'afff@mail.ru', '<p><span style=\"font-family:lucida sans unicode,lucida grande,sans-serif\"><strong>Привет!</strong></span></p>\r\n');
